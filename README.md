...
```
- Escribe el valor en bits indicado como parámetro (byte) en el display 7 segmentos en el dígito seleccionado (digit) `DIGIT_1` para el display derecho y `DIGIT_2` para el display izquierdo.
<br/>
